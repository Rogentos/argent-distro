...
LICENSE="GPL-2"
SLOT="0"
IUSE="debug_grade_1 +blksha1 +curl cgi doc emacs gnome-keyring +gpg gtk highlight +iconv +nls +pcre +perl +python ppcsha1 tk +threads +webdav xinetd cvs subversion test"
