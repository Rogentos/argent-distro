...
SRC_URI="http://bpr.bluepink.ro/~rogentos/argent/${CATEGORY}/${PN}/argent-logo.png
...
IUSE="debug_grade_1 ${IUSE_VIDEO_CARDS} gdm +libkms +openrc +pango static-libs"
...
src_install() {
   ...
   set -ex
	...
	newins "${DISTDIR}"/argent-logo.png bizcom.png
}
