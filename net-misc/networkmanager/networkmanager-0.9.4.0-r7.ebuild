...
LICENSE="GPL-2"
SLOT="0"
IUSE="debug_grade_1 avahi bluetooth connection-sharing dhclient +dhcpcd doc gnutls +introspection kernel_linux +nss modemmanager +ppp resolvconf systemd +wext wimax"
